...
UI.enable       = ui.new_checkbox("Hitlog", "Enable Hitlog")
UI.show_misses  = ui.new_checkbox("Hitlog", "Show misses")
UI.show_method  = ui.new_checkbox("Hitlog", "Show resolver method")
UI.show_stats   = ui.new_checkbox("Hitlog", "Show session stats bar")
UI.show_kills   = ui.new_checkbox("Hitlog", "Highlight kills")
UI.max_entries  = ui.new_slider("Hitlog", "Max visible entries", 3, 20, 10)
UI.entry_life   = ui.new_slider("Hitlog", "Entry lifetime (s)", 2, 15, 6)
UI.panel_x      = ui.new_slider("Hitlog", "Panel X offset", 0, 1920, 10)
UI.panel_y      = ui.new_slider("Hitlog", "Panel Y offset", 0, 1080, 300)
UI.panel_w      = ui.new_slider("Hitlog", "Panel width", 200, 500, 320)
UI.bg_alpha     = ui.new_slider("Hitlog", "Background opacity", 0, 255, 180)
UI.rainbow_hdr  = ui.new_checkbox("Hitlog", "Rainbow header")
UI.hdr_col      = ui.new_color_picker("Hitlog", "Header colour", 255, 200, 60, 255)
UI.hit_col      = ui.new_color_picker("Hitlog", "Hit entry colour", 80, 220, 80, 255)
UI.miss_col     = ui.new_color_picker("Hitlog", "Miss entry colour", 255, 80, 80, 255)
UI.kill_col     = ui.new_color_picker("Hitlog", "Kill highlight colour", 255, 60, 200, 255)
UI.slide_anim   = ui.new_checkbox("Hitlog", "Slide-in animation")
UI.dmg_col_mode = ui.new_checkbox("Hitlog", "Colour entries by damage")
