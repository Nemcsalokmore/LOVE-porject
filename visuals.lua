...
-- ── ESP ──────────────────────────────────────────────────────────────────────
UI.esp_enable    = ui.new_checkbox("Visuals", "ESP", "Enable ESP")
UI.esp_enemies   = ui.new_checkbox("Visuals", "ESP", "Enemies")
UI.esp_team      = ui.new_checkbox("Visuals", "ESP", "Teammates")
UI.box_style     = ui.new_combobox("Visuals", "ESP", "Box Style", {"Corner", "Full", "3D"})
UI.box_col_e     = ui.new_color_picker("Visuals", "ESP", "Enemy box colour",    255, 60,  60,  255)
UI.box_col_t     = ui.new_color_picker("Visuals", "ESP", "Team box colour",     60,  180, 255, 255)
UI.health_bar    = ui.new_checkbox("Visuals", "ESP", "Health bar")
UI.armour_bar    = ui.new_checkbox("Visuals", "ESP", "Armour bar")
UI.name_tag      = ui.new_checkbox("Visuals", "ESP", "Name tag")
UI.weapon_tag    = ui.new_checkbox("Visuals", "ESP", "Weapon tag")
UI.ammo_bar      = ui.new_checkbox("Visuals", "ESP", "Ammo bar")
UI.distance_tag  = ui.new_checkbox("Visuals", "ESP", "Distance tag")
UI.flags_tag     = ui.new_checkbox("Visuals", "ESP", "Flags (scoped/flash/etc)")
UI.snap_lines    = ui.new_checkbox("Visuals", "ESP", "Snap lines")
UI.snap_origin   = ui.new_combobox("Visuals", "ESP", "Snap origin", {"Bottom", "Crosshair"})

-- ── Skeleton ─────────────────────────────────────────────────────────────────
UI.skeleton      = ui.new_checkbox("Visuals", "Skeleton", "Skeleton")
UI.head_dot      = ui.new_checkbox("Visuals", "Skeleton", "Head dot")
UI.skel_col_e    = ui.new_color_picker("Visuals", "Skeleton", "Enemy skeleton colour",  255, 100, 100, 200)
UI.skel_col_t    = ui.new_color_picker("Visuals", "Skeleton", "Team skeleton colour",   100, 180, 255, 200)

-- ── Hit effects ──────────────────────────────────────────────────────────────
UI.hitmarker     = ui.new_checkbox("Visuals", "Effects", "Hit marker")
UI.hit_col       = ui.new_color_picker("Visuals", "Effects", "Hit marker colour", 255, 255, 255, 255)
UI.dmg_numbers   = ui.new_checkbox("Visuals", "Effects", "Damage numbers")
UI.dmg_col       = ui.new_color_picker("Visuals", "Effects", "Damage number colour", 255, 60, 60, 255)

-- ── World ─────────────────────────────────────────────────────────────────────
UI.bomb_timer    = ui.new_checkbox("Visuals", "World", "Bomb timer")
UI.grenade_pred  = ui.new_checkbox("Visuals", "World", "Grenade prediction")
UI.radar         = ui.new_checkbox("Visuals", "World", "Radar")
UI.radar_size    = ui.new_slider("Visuals", "World", "Radar size", 80, 300, 160)

-- ── Misc ─────────────────────────────────────────────────────────────────────
UI.watermark     = ui.new_checkbox("Visuals", "Misc", "Watermark")
UI.spectators    = ui.new_checkbox("Visuals", "Misc", "Spectator list")
UI.crosshair     = ui.new_checkbox("Visuals", "Misc", "Custom crosshair")
UI.crosshair_col = ui.new_color_picker("Visuals", "Misc", "Crosshair colour", 255, 255, 255, 220)
UI.rainbow_box   = ui.new_checkbox("Visuals", "Misc", "Rainbow box")
