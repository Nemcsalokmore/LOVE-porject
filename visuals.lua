...
-- ── ESP ──────────────────────────────────────────────────────────────────────
UI.esp_enable    = ui.new_checkbox("LUA", "a", "ESP: Enable")
UI.esp_enemies   = ui.new_checkbox("LUA", "a", "ESP: Enemies")
UI.esp_team      = ui.new_checkbox("LUA", "a", "ESP: Teammates")
UI.box_style     = ui.new_combobox("LUA", "a", "ESP: Box Style", {"Corner", "Full", "3D"})
UI.box_col_e     = ui.new_color_picker("LUA", "a", "ESP: Enemy box colour",    255, 60,  60,  255)
UI.box_col_t     = ui.new_color_picker("LUA", "a", "ESP: Team box colour",     60,  180, 255, 255)
UI.health_bar    = ui.new_checkbox("LUA", "a", "ESP: Health bar")
UI.armour_bar    = ui.new_checkbox("LUA", "a", "ESP: Armour bar")
UI.name_tag      = ui.new_checkbox("LUA", "a", "ESP: Name tag")
UI.weapon_tag    = ui.new_checkbox("LUA", "a", "ESP: Weapon tag")
UI.ammo_bar      = ui.new_checkbox("LUA", "a", "ESP: Ammo bar")
UI.distance_tag  = ui.new_checkbox("LUA", "a", "ESP: Distance tag")
UI.flags_tag     = ui.new_checkbox("LUA", "a", "ESP: Flags")
UI.snap_lines    = ui.new_checkbox("LUA", "a", "ESP: Snap lines")
UI.snap_origin   = ui.new_combobox("LUA", "a", "ESP: Snap origin", {"Bottom", "Crosshair"})

-- ── Skeleton ─────────────────────────────────────────────────────────────────
UI.skeleton      = ui.new_checkbox("LUA", "a", "ESP: Skeleton")
UI.head_dot      = ui.new_checkbox("LUA", "a", "ESP: Head dot")
UI.skel_col_e    = ui.new_color_picker("LUA", "a", "ESP: Enemy skeleton colour",  255, 100, 100, 200)
UI.skel_col_t    = ui.new_color_picker("LUA", "a", "ESP: Team skeleton colour",   100, 180, 255, 200)

-- ── Hit effects ──────────────────────────────────────────────────────────────
UI.hitmarker     = ui.new_checkbox("LUA", "a", "ESP: Hit marker")
UI.hit_col       = ui.new_color_picker("LUA", "a", "ESP: Hit marker colour", 255, 255, 255, 255)
UI.dmg_numbers   = ui.new_checkbox("LUA", "a", "ESP: Damage numbers")
UI.dmg_col       = ui.new_color_picker("LUA", "a", "ESP: Damage number colour", 255, 60, 60, 255)

-- ── World ─────────────────────────────────────────────────────────────────────
UI.bomb_timer    = ui.new_checkbox("LUA", "a", "ESP: Bomb timer")
UI.grenade_pred  = ui.new_checkbox("LUA", "a", "ESP: Grenade prediction")
UI.radar         = ui.new_checkbox("LUA", "a", "ESP: Radar")
UI.radar_size    = ui.new_slider("LUA", "a", "ESP: Radar size", 80, 300, 160)

-- ── Misc ─────────────────────────────────────────────────────────────────────
UI.watermark     = ui.new_checkbox("LUA", "a", "ESP: Watermark")
UI.spectators    = ui.new_checkbox("LUA", "a", "ESP: Spectator list")
UI.crosshair     = ui.new_checkbox("LUA", "a", "ESP: Custom crosshair")
UI.crosshair_col = ui.new_color_picker("LUA", "a", "ESP: Crosshair colour", 255, 255, 255, 220)
UI.rainbow_box   = ui.new_checkbox("LUA", "a", "ESP: Rainbow box")
